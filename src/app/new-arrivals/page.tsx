...
export default function NewArrivalsPage() {
  ...
  const { products, loading, error } = useProductCatalog({ sortBy: 'newest' });
    ...
    <div className="min-h-screen bg-[#fafafa] text-neutral-900 selection:bg-neutral-900 selection:text-white">
      <main className="max-w-7xl mx-auto px-6 py-12">
        <header className="mb-16">
          <p className="text-sm font-black text-emerald-600 uppercase tracking-widest mb-3">Freshly Picked</p>
          <h2 className="text-5xl md:text-6xl font-black tracking-tighter leading-none mb-6">
            NEW ARRIVALS
          </h2>
          <p className="text-neutral-500 max-w-lg">
            Discover our latest additions, crafted with the same attention to detail and quality you expect from Gravity.
          </p>
        </header>
